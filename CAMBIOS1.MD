...
2. [ ] Migrar rutas criticas para usar exclusivamente el contrato (`home`, `onboarding`, `drill`, `progress`).
3. [ ] Agregar cobertura E2E extra para regresiones de URL canónica.
