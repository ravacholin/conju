...
1. [ ] Definir fixtures estables por verbos top y casos limite.
2. [ ] Crear golden tests para no-finitos irregulares y preteritos fuertes.
3. [ ] Integrar comparador before/after para detectar regresion linguistica.
