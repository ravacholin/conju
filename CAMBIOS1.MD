...
2. [ ] Integrar la capa de index para contemplar contexto adicional (`region`) sin romper contratos actuales.
3. [ ] Validar impacto con benchmark reproducible del generador (before/after, p50/p95).
